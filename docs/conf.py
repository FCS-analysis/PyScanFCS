...
# -*- coding: utf-8 -*-
#
# PyScanFCS documentation build configuration file, created by
...
# Get version number from PyScanFCS._version file
import mock
import os
...
install_requires = ["lmfit", "numpy", "matplotlib", "pyyaml", "scipy",
                    "scipy.fftpack", "astropy", "astropy.io",
                    "astropy.io.fits", "wxPython", 
                    "skimage", "skimage.external.tifffile"]
...
rst_prolog = """
:github_url: https://github.com/FCS-analysis/PyScanFCS
"""
...
# This gets 'version'
exec(open(op.join(pdir, "pyscanfcs/_version.py")).read())
...
htmlhelp_basename = 'PyScanFCSdoc'
...
latex_documents = [
    (master_doc, 'PyScanFCS.tex', 'PyScanFCS Documentation',
     'Paul Müller', 'manual'),
]
...
man_pages = [
    (master_doc, 'PyScanFCS', 'PyScanFCS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, project, project + ' Documentation',
     author, project, 'Perpendicular line scanning FCS.',
     'Scientific'),
]
