![PyScanFCS](https://raw.github.com/FCS-analysis/PyScanFCS/master/doc/Images/PyScanFCS_logo_dark.png)
=========
...
[MakeTestDat_SFCS.py](https://github.com/FCS-analysis/multipletau/blob/master/MakeTestDat_SFCS.py).
The obtained correlation curves can be fitted with
[PyCorrFit](https://github.com/FCS-analysis/PyCorrFit) using the
[appropriate model function](https://github.com/FCS-analysis/multipletau/blob/master/ExampleFunc_Exp_correlated_noise.txt).

For further information, please visit the PyScanFCS homepage at
[http://pyscanfcs.craban.de](http://pyscanfcs.craban.de).

- [Download the latest version](https://github.com/FCS-analysis/PyScanFCS/releases)
- [Documentation](https://github.com/FCS-analysis/PyScanFCS/wiki/PyScanFCS_doc.pdf)
- [Using Cython on Windows XP](https://github.com/FCS-analysis/PyScanFCS/wiki/Using-Cython-on-Windows-XP)
