...
\item \textbf{Sources}
The program is written in python 2.7. On any operating system, PyScanFCS can be run from source. The following packages need to be installed:
\texttt{\\
cython ($\geq$ 0.1.6)\\
...
\includegraphics[width=0.95\linewidth]{PyScanFCS_Main.png}
 \mycaption{user interface of PyScanFCS}{The screenshot was taken on an Ubuntu desktop environment. \label{fig:SFCSMain}}
\end{figure}
